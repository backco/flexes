		...
		public void endElement(String uri, String localName, String qName)
			...
			if (tagName.equalsIgnoreCase("global")) {
				...
				if (globals != null) {
					...
					//System.out.println("    added to globals");
				} else {
				    	//System.out.println("    adding to parent collection");
					attributableStack.peek().getAttributes()
							.put(attribute.getKey(), attribute);
				    	//System.out.println("    parent attributable: " + attributableStack.peek().toString());
